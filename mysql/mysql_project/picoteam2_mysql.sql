...
가상 데이터
insert into temp_humidity_sensor values (1, 1, '정상작동', 25.00, 60.00, NOW(), '없음'); 
insert into temp_humidity_sensor values (2, 1, '정상작동', 24.50, 58.00, NOW(), '없음');
insert into temp_humidity_sensor values (3, 2, '정상작동', 26.00, 65.00, NOW(), '없음');
insert into temp_humidity_sensor values (4, 2, '정상작동', 25.50, 63.00, NOW(), '없음');
insert into temp_humidity_sensor values (5, 3, '정상작동', 28.00, 70.00, NOW(), '없음');
insert into temp_humidity_sensor values (6, 3, '정상작동', 27.50, 68.00, NOW(), '없음');
insert into temp_humidity_sensor values (7, 4, '정상작동', 25.40, 62.00, NOW(), '없음');
insert into temp_humidity_sensor values (8, 4, '정상작동', 24.90, 59.00, NOW(), '없음');
insert into temp_humidity_sensor values (9, 5, '정상작동', 26.20, 67.00, NOW(), '없음');
insert into temp_humidity_sensor values (10, 5, '정상작동', 25.80, 64.00, NOW(), '없음');
insert into temp_humidity_sensor values (11, 6, '정상작동', 27.00, 69.00, NOW(), '없음');
insert into temp_humidity_sensor values (12, 6, '정상작동', 26.50, 66.00, NOW(), '없음');
insert into temp_humidity_sensor values (13, 7, '정상작동', 24.80, 61.00, NOW(), '없음');
insert into temp_humidity_sensor values (14, 7, '정상작동', 24.30, 57.00, NOW(), '없음');

insert into temp_humidity_sensor values (15, 8, '점검요함', -12381.12 , 13.02, NOW(), '오류 예상');
insert into temp_humidity_sensor values (16, 8, '정상작동' , 25.00, 60.00, NOW(), '없음');

insert into temp_humidity_sensor values (17, 9, '점검요함', 50.00, 5.00, NOW(), '오류 혹은 이상고온 예상');
insert into temp_humidity_sensor values (18, 9, '점검요함', 49.00, 4.00, NOW(), '오류 혹은 이상고온 예상');

insert into temp_humidity_sensor values (19, 10, '미사용', null, null, NOW(), '없음');
insert into temp_humidity_sensor values (20, 10, '미사용', null, null, NOW(), '없음');
...
조도 센서 (main.c L477-482, mqt_server.py L69-71)
정상:3949
과다 (≥ 3950): 차양막 자동 닫힘
이유: 식물 보호 + 채광 최적화

토양 수분 센서 (main.c L83-84, L510-511, mqt_server.py L75)
계산: soil_value = 4095 - soil_raw
정상: > 1100 (습함)
건조 (≤ 1100): 펌프 자동 ON
이유: 자동 관개 트리거

수위 센서 (main.c L88-89, L434-441, mqt_server.py L82)
계산: level_percent = ((water_raw ÷ 3200) × 100)
정상: 50% ~ 100%
부족 (< 50%): water_low 경고 발생 및 텔레그램 알림
이유: 물탱크 고갈 방지

온습도 센서 (mqt_server.py L76-82)
현재: 임계값 설정 없음 (실시간 값 그대로 저장)
용도: 환경 모니터링만
권장: 온도 20~40°C, 습도 30~80% 추가 설정